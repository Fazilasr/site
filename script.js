...
const creatures = [
    ...
    {
        name: "Yach.    It's sound will be added soon too.",
        image: "./images/yach.jpeg",
        description: "In the heart of Kashmir’s mist-laden valleys lies a creature steeped in mystery—the elusive Yach. This rare, cat-like animal with a bigger head is the subject of countless local myths, shrouded in an aura of the supernatural. Known for the eerie, almost otherworldly sound it emits, the Yach’s call pierces the quiet nights, evoking both awe and fear among those who hear it. Mysterious sightings are rare and fleeting, as the Yach appears only during the enigmatic nights of February, Elusive and almost impossible to catch sight of, the Yach remains one of Kashmir’s most enigmatic legends, guarding its secrets in the shadows of the night. it's sound will be added soon too!!!",
        soundUrl: "sounds/ysch.m4a",
        diet: "Unknown",
        lifespan: "Unknown",
        habitat: "Urban areas of Kashmir🍁"
    },
    ...
    {
        name: "Puffin",
        image: "./images/puffin.jpeg",
        description: "Known for its colorful beak, the Puffin is a skilled swimmer and dives deep to catch fish.",
        soundUrl: "sounds/puffin.m4a",
        diet: "Carnivore (fish)",
        lifespan: "20 years",
        habitat: "Coastal cliffs in the Northern Hemisphere"
    },
    {
        name: "snowy owl",
        image: "./images/snowy owl.jpeg",
        description: "The Snowy Owl, with its white plumage, is well adapted to the cold Arctic tundra.",
        soundUrl: "sounds/snowy owl.m4a",
        diet: "Carnivore (small mammals)",
        lifespan: "10 years in the wild",
        habitat: "Arctic regions, open fields"
    },
    {
        name: "Parrot",
        image: "./images/parrot.jpeg",
        description: "Parrots are known for their vibrant feathers and ability to mimic sounds, including human speech.",
        soundUrl: "sounds/parrot.mp3",
        diet: "Omnivore (fruits, seeds)",
        lifespan: "50 years",
...
document.getElementById('creatureSearch').addEventListener('input', function() {
    const query = this.value.toLowerCase();
    const creatureCards = document.querySelectorAll('.creature-card');

    creatureCards.forEach(card => {
        const creatureName = card.querySelector('.creature-name').textContent.toLowerCase();
        card.style.display = creatureName.includes(query) ? 'block' : 'none';
    });
});
